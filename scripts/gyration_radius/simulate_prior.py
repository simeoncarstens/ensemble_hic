...
bead_radii = np.loadtxt(os.path.expanduser('~/projects/ensemble_hic/scripts/bau2011/bead_radii_fixed.txt'))
...
if rank == 0:
    ...
    BBP = make_backbone_prior(bead_radii, {'force_constant': 500},
                              len(bead_radii), 1)
    ...
    subsamplers = {'structures': HMCSampler(posterior,
