...
simpath = '/scratch/scarste/ensemble_hic/nora2012/bothdomains_it{}_rep3_{}structures_{}replicas/'.format(it, n_structures, n_replicas)
...
# axes[1,0].set_yticklabels(['{:.2e}'.format(x * 3e3 / (4./3. * np.pi * cutoff ** 3))
#                            for x in axes[1,0].get_yticks()])
